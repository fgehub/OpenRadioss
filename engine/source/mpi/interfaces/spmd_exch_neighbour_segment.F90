...
!
          ...
          do i=1,nspmd
              ...
              if(frontier_elm>0) then
                ...
                call spmd_irecv(r_buffer_size(1:2,i),2,i-1,spmd_tag_1,request_r_1(recv_nb_1),COMM_RADIOSS)
          ...
          do i=1,nspmd
              frontier_elm = iad_elem(1,i+1)-iad_elem(1,i) ! check if the proc "i" is a neighbour
              if(frontier_elm>0) then
                  call spmd_isend(s_buffer_size(1:2,i),2,i-1,spmd_tag_1,request_s_1(i),COMM_RADIOSS)
              endif
          enddo
          ! ----------------
            ...
            do i=1,recv_nb_1
                ...
                if(r_buffer_size(1,proc_id)>0) then
                  ...
                  call spmd_irecv( r_buffer(proc_id)%my_real_array_1d,my_size,proc_id-1,              &
                                   spmd_tag_2,request_r_2(recv_nb_2),COMM_RADIOSS )
                endif
            enddo
          endif
          ! ----------------
          ...
          do i=1,nspmd
              ...
              if(s_buffer_size(1,i)>0) then
                  ...
                  call spmd_isend(s_buffer(i)%my_real_array_1d,my_size,i-1,spmd_tag_2,request_s_2(i),COMM_RADIOSS)
              endif
          enddo
          ! ----------------
          ...
          do i=1,nspmd
            frontier_elm = iad_elem(1,i+1)-iad_elem(1,i) ! check if the proc "i" is a neighbour
            if(frontier_elm>0) then
              call spmd_isend(s_buffer_2_size(:,i),3,i-1,spmd_tag_3,request_s_3(i),COMM_RADIOSS)
          ...
          do i=1,nspmd
              ...
              if(frontier_elm>0) then
                ...
                call spmd_irecv(r_buffer_2_size(:,i),3,i-1,spmd_tag_3,request_r_3(recv_nb_3), COMM_RADIOSS)
            ...
            do i=1,recv_nb_3
              ...
              if(r_buffer_2_size(1,proc_id)>0) then
                ...
                call spmd_irecv( r_buffer_2(proc_id)%my_real_array_1d,my_size, &
                                 proc_id-1,spmd_tag_4,request_r_4(recv_nb_4), COMM_RADIOSS )
              endif
            enddo
          endif
          ! ----------------
